...
<img  
    ...
    alt="Produto 1 do Mercado Lyra." class="group-hover:scale-110 duration-300 my-3 rounded-lg"
/>
<p class="text-sm">${produtoCatalogo.marca}</p>
<p class="text-sm">${produtoCatalogo.nome} </p>
<p class="text-sm">$${produtoCatalogo.preco}</p>
<button id="adicionar-${produtoCatalogo.id}" class="bg-slate-900 hover:bg-yellow-500 text-slate-200"><i class="fa-solid fa-cart-plus "></i></button>
</div>`;
